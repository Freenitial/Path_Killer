...
REM How to call with args : kill_processes_by_folder.bat /folder "C:\first\folder" /folder "C:\second folder" /recursive 1 /testing 0
...
set "folders="C:\first\folder";"C:\second folder""   :: List of folders formated like this
